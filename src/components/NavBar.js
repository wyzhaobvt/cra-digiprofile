      ...
      <>
        <nav className="navbar navbar-expand-md navbar-light justify-content-center sticky-top">
          <div className="container  mb-0">
            ...
            <div className="collapse navbar-collapse mb-0 bar " id="collapsibleNavId">
                <ul className="navbar-nav me mt-2 mt-lg-0 justify-content-around w-100 pe-0">
                    <li className="nav-item d-flex align-items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-house" viewBox="0 0 16 16">
                            <path d="M8.707 1.5a1 1 0 0 0-1.414 0L.646 8.146a.5.5 0 0 0 .708.708L2 8.207V13.5A1.5 1.5 0 0 0 3.5 15h9a1.5 1.5 0 0 0 1.5-1.5V8.207l.646.647a.5.5 0 0 0 .708-.708L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293L8.707 1.5ZM13 7.207V13.5a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5V7.207l5-5 5 5Z"/>
                          </svg>
                        <a className="nav-link active" href="#profile" aria-current="page">Profile<span className="visually-hidden">(current)</span></a>
                    </li>
                    <li className="nav-item d-flex align-items-center">
                        ...
                        <a className="nav-link" href="#experience" aria-current="page">Experience <span className="visually-hidden"></span></a>
                    </li>
                    <li className="nav-item d-flex align-items-center">
                    ...
                    <li className="nav-item d-flex align-items-center">
                        ...
                        <a className="nav-link" href="#technology">Technical skills</a>
                    </li>
                    <li className="nav-item d-flex align-items-center">
                        ...
                        <a className="nav-link" href="#education">Education & Certificates</a>
                    </li>
                    <li className="nav-item d-flex align-items-center">
